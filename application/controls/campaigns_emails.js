app.controller('viewCampaignEmails', function($scope, $http, $routeParams, $rootScope, $uibModal, AuthManager)
{
    ...
    $scope.load = function()
    {
        AuthManager.get('/campaigns_emails/view',
        {
            view_type: 'view',
    ...
    $scope.preview = function($id)
    {
        ...
        {
            templateUrl: 'application/views/campaigns/emailsPreview.htm',
    ...
    $scope.reminder = function($id)
    {
        var uibModalInstance = $uibModal.open(
        {
            templateUrl: 'application/views/campaigns/emailsReminder.htm',
...
app.controller('previewAdReminder', function($scope, $http, $sce, $uibModalInstance, id)
{
    ...
    $http.post('/app/campaigns_emails/preview',
    {
        view_type: 'edit',
        id: id
    },
