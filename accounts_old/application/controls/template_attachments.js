app.controller( 'viewTemplatesPdf', function( $scope, $http, $rootScope, $uibModal, AuthManager ) {
    ...
    $scope.load = function() {
        AuthManager.get( '/template_attachments/view', { view_type: 'view' } ).then( function( results ) {
    ...
    $scope.add = function() {
        var uibModalInstance = $uibModal.open( {
            animation: false,
            templateUrl: 'application/views/template_attachments/add.php',
    ...
    $scope.edit = function( $id ) {
        var uibModalInstance = $uibModal.open( {
            animation: false,
            templateUrl: 'application/views/template_attachments/edit.php',
...
app.controller( 'editTemplatesPdf', function( $scope, $http, $uibModalInstance, AuthManager, id ) {
    ...
    $scope.load = function() {
        AuthManager.get( '/template_attachments/view', { view_type: 'edit', id: id } ).then( function( results ) {
            $scope.results = results.data;
