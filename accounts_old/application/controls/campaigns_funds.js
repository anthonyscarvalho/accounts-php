app.controller('viewCampaignFunds', function($scope, $http, $routeParams, $rootScope, $filter, AuthManager, $uibModal) {
    ...
    $scope.add = function() {
        var uibModalInstance = $uibModal.open({
            animation: false,
            templateUrl: 'application/views/campaigns/fundsAdd.php',
    ...
    $scope.edit = function($id) {
        var uibModalInstance = $uibModal.open({
            templateUrl: 'application/views/campaigns/fundsEdit.php',
...
app.controller('editCampaignFunds', function($scope, AuthManager, $uibModalInstance, id) {
    ...
    $scope.load = function() {
        AuthManager.get('/campaigns_funds/view/', { view_type: "edit", id: id }).then(function(results) {
...
app.controller('addCampaignFunds', function($scope, $routeParams, $rootScope, $filter, $uibModalInstance, AuthManager, parent) {
    ...
    $scope.load = function() {
        AuthManager.get('/campaigns_clients/view/', { view_type: 'view', id: parent }).then(function(results) {
