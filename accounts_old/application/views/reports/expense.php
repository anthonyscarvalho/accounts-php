...
<ol class="breadcrumb">
    ...
    <li class="active"><a href="#/reports/expense">Expense</a></li>
    ...
    <div class="col-md-3">
        <div class="well well-sm">
            ...
            <div class="form-group text-center">
                ...
                <button type="button" ng-click="exportToExcel( '#incomeOverview' )" class="pull-right btn btn-primary"><span class="fa fa-download"></span></button>
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <table class="table table-condensed table-hover table-striped click" id="incomeOverview">
            ...
            <tbody ng-repeat="res in results" ng-init="val = updateTotal( res.data )">
                ...
                <tr ng-repeat="ress in res.data">
                    ...
                    <td class="text-right">{{ress.amount| number: 2}}</td>
                </tr>
                <tr>
