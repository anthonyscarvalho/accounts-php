...
<div class="row">
    <div class="col-md-3">
        <div class="well well-sm">
            ...
            <div class="form-group text-center">
                ...
                <button ng-click="add( parent )" class="btn btn-primary"><span class="fa fa-plus"></span></button>
            </div>
            <div class="form-group">
                <ul class="list-group">
    ...
    <div class="col-md-9">
        <table class="table table-condensed table-hover table-striped click" at-table at-paginated at-list="list" at-config="config">
            ...
            <tbody>
                <tr ng-repeat="res in results | orderBy:sort.sortType:sort.sortReverse " ng-init="setTotals( res );
                                    val = updateTotal( res )">
                    <td>{{res.id}}</td>
                    <td>{{res.date}}</td>
                    <td>{{res.comment}}</td>
                    ...
                    <td>
                        <div ng-show="res.id != 0">
                            ...
                            <span>
                                <a class="btn btn-warning btn-xs" ng-click="remove( res.id, loaded )"><span class="fa fa-trash"></span></a>
                            </span>
                        </div>
                    </td>
                </tr>
