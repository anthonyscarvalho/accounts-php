...
<div class="row">
    <div class="col-md-3">
        <div class="well well-sm">
            ...
            <div class="form-group">
                <label>Year</label>
                <input type="text" class="form-control input-sm" maxlength="250" ng-model="exp.year" value="" required data-date-format="yyyy" data-provide="datepicker" data-date-min-view-mode="2" data-date-max-view-mode="2">
            </div>
            <div class="form-group">
                <label>Company</label>
